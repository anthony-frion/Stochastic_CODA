...
class MMDLoss:
    """MMD loss function.
    Aims at training CODA models with stochastic outputs.
    We assume that the model's outputs are parameters of a diagonal Gaussian distribution.
    The data consistency term is computed using the negative log likelihood given the observations.
    The model consistency term is computed with the MMD between sets of samples.
    /!\ Work in progress
